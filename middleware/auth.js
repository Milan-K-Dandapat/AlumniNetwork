...
// --- YOUR EXISTING AUTH FUNCTION (Correct + Debugging Added) ---
...
const auth = (req, res, next) => {
    ...
    try {
        ...
        // --- (*** ADDED FOR DEBUGGING ***) ---
        // This will print the user object (including role) to your backend console
        console.log('DEBUG: req.user in auth middleware:', req.user);
        // ------------------------------------
